...
const APP_NAME = "Human Potential";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Human Potential — an educational operating system for body, mind, and life. Assessment, clinic atlas, protocols, kitchen, and a medical desk. Not a licensed clinic.",
      },
